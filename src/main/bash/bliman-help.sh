...
__bliman_echo_no_colour '   --version: For passing the version number.                                                          '
__bliman_echo_no_colour '  '
...
function __bli_help_initmode {
    ...
    __bliman_echo_no_colour '   Available modes are:                                                                             '
    __bliman_echo_no_colour '      host - This mode installs lab on a virtual machine.                                           '
    __bliman_echo_no_colour '      bare - In this mode lab is installed on local or remote machine using ansible roles.          '
    __bliman_echo_no_colour '      lite - Lite mode is the lightweight mode and installs the lab using only shell scripts.       '
    __bliman_echo_white 'EXAMPLE'
