...
function __bli_help_create {
    ...
    __bliman_echo_no_colour '       --password: Password for the new user for login                                             '
    ...
    __bliman_echo_no_colour '       <gitlab|github>:<user first name>:<user last name>:<username>:<email>:<password>:<isadmin>:<isexternal>:<isprivate>'
    ...
    __bliman_echo_no_colour '       --namespace: Namespace under which project need to be created                               '
    ...
    __bliman_echo_no_colour '               options. Format of file should be as below.                                         '
    __bliman_echo_no_colour '       <gitlab|github>:<project name>:<project description>:<project namespace>:<project visibility> '
    __bliman_echo_no_colour '       replace with the values and remove < and > from each field.'
    __bliman_echo_no_colour '  '
    __bliman_echo_white 'EXAMPLE'
    ...
    __bliman_echo_no_colour '  $ bli create user --lab <github|gitlab> --firstname <user first name> --lastname <user last name> --username <username> --password <password> --isadmin <true|false> --isexternal <true|false> --isprivate <true|flase>'
    __bliman_echo_no_colour '  $ bli create project --token <user token> --projectname <name of project> --projectdesc <project descr> --namespace <namespace for the project> --visibility <public|private|internal>'
    __bliman_echo_no_colour '  '
}
