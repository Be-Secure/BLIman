...
EOF
	...
	echo "* Downloading..."
	curl --fail --location --progress-bar "https://raw.githubusercontent.com/asa1997/BLIman/issue%234/bin/0.1.0.zip" > "$bliman_zip_file"
	...
	cp "$bliman_tmp_folder"/src/main/bash/bliman-*.sh "$bliman_src_folder"
...
function __bliman_load_export_vars() {
	...
	echo "echo "sourcing tmp file"" >> "$tmp_file"
